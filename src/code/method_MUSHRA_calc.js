...
exports.MUSHRAParadigm = function (_objtxt)
{
    ...
    switch (_objtxt.testSettings.modalityRatio)
    {
        ...
        case "AV":
            error("Multiple Stimulus with Hidden Reference and Anchor (MUSHRA) is an audio only test method... cannot test multiple parallel visual conditions in parallel. Please set the modalityRatio to 'A' in the .json file", '\n');
        break;
