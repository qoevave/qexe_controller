...
// Create the routing obects for the buttons and sliders incoming OSC message. 
function CreateRouteObjects(val)
{
    ...
    for (i = 0; i<val; i++)
    {
        routeSliderNames[i] = String("/slider/bs1284/"+(i+1));
        routeButtonNames[i] = String("/btn/condition/bs1284/"+(i+1));
    }
